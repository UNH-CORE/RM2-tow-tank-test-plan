...
effort are provided in Neary et al.

\todo[inline]{Get citation for Neary et al., 2014}
...
be exceeded, such that scale model results can be extrapolated.  
...
\todo[inline]{List and define quantities we want to obtain, then describe what
primitive measurements are required.}
...
\todo[inline]{Describe this process, including extraction of steady state
duration, and elimination of bad velocity datapoints from Vince and Budi's
papers}
