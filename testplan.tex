...
and a drawing of the experimental setup is shown in Figure~\ref{fig-exp_setup}.
...
Turbine torque & Load cell (\& arm) & Sentran ZB3-200 & $\pm$0.2 Nm \\
...
\end{tabular}
\caption{Details of the sensors to be used for the experiment.}
\label{tab-sensors}
\end{table}
