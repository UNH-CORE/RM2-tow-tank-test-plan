...
Additional performance curve test sections are created/executed for different
tow speeds. For wake characterization, sections will vary the cross-stream
position of the velocity probe, providing a single profile. Multiple
cross-stream profiles would be taken at varying vertical locations, each of
which would represent a test section.
