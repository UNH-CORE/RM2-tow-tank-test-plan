...
drag model in CACTUS could be the source of some discrepancy. The strut drag will be deliberately modified in the physical model to provide data to help answer that question. This dataset will be
...
The turbine is to be a 1:6 scale model of the RM2 rotor. Turbine geometry is to be scaled from the RM2 ``rev 0''
