...
speed, and Vectrino velocity measurements.

Tare torque and drag runs will also be performed.

Raw and processed data, along with the processing and plotting code, will be
uploaded to both figshare (http://figshare.com) and GitHub (http://github.com).
Figshare provides a digital object identifier (DOI) for each dataset, while
GitHub provides a mechanism for updating the code and processed data, both by
the investigators and third parties.
